                        ...
                        <div class="flex flex-row justify-around mt-2 space-x-5">
                            ...
                            <div class="mt-2 w-3/5 space-y-1">
                                <div>
                                    ...
                                    placeholder="Enter product description ..." v-model.trim="product.productDescription" @blur="validateProductDetail" class="w-full px-3 py-2 mb-1 h-52 font-medium text-left bg-white border-2 border-orange border-opacity-50y rounded-md"/>
                                ...
                                <div class=" pt-1.5">
                                    ...
                                    <div class="grid grid-cols-10 md:grid md:grid-cols-5 md:justify-items-start ">
                                            <input type="checkbox" class="h-10 w-10 appearance-none rounded-md" !checked
